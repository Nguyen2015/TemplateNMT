...
bash ./scripts/run_gen_template_probt.sh $DATA_DIR false # second parameter [false] indicate the template is parsed in target side
...
cp ../../scripts/iwslt14deen-tgt-probt-step1-setting.sh setting.sh
cd $ROOT_DIR
...
# generate template 
# # --------------
bash ./scripts/translate_template.sh $DATA_DIR "probt"
...
cp ../../scripts/iwslt14deen-tgt-probt-step2-setting.sh setting.sh
cd $ROOT_DIR
